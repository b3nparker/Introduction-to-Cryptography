...
| 4       | - Sequential composition of PRGs (the Blum-Micali construction) <br> - The Salsa and Chacha PRGs | - Boneh&Shoup 3.4, 3.6 |
| 5       | - The Content Scrambling System (CSS) <br> - Pseudorandom Number Generator (PRNG) - Generating random bits in practice | - Boneh&Shoup 3.7, 3.8, 3.10 |
